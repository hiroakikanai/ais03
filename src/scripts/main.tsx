...
class ForInputAction extends React.Component<ForInputActionProps, ForInputActionState>{
  constructor(props:ForInputActionProps){
    super(props);
    this.state={inputChara:"",muraiClassName:"murai_animation_1", muraiSrc:"images/murai/1.png"};
  };
  ...
  private handleSubmit(e:React.SyntheticEvent<{}>){
    if(this.state.inputChara == ""){e.preventDefault();}else{
...
class Main extends React.Component<{},MainState>{
  constructor(props:{}){
    super(props);
    this.state = {displistpost:new InputTextList(),answerlistpost:new InputTextList()};
  };
